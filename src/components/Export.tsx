...
export function ExportSection() {
  ...
  return (
    <section id="export" className="relative bg-gradient-to-br from-cream via-cream to-amber-50/30 py-16 md:py-20 overflow-hidden scroll-mt-24">
      {/* Subtle Background Pattern */}
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none">
        <div className="absolute inset-0" style={{
          backgroundImage: `radial-gradient(circle at 2px 2px, #234B2F 1px, transparent 0)`,
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        >
          <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-forest/5 border border-forest/10 mb-4">
            <Globe className="w-4 h-4 text-gold" />
            <span className="text-sm uppercase tracking-wider text-forest font-semibold">Global Export Partner</span>
          </div>
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                onMouseEnter={() => setHoveredCard(index)}
                onMouseLeave={() => setHoveredCard(null)}
                className="group relative h-[460px] md:h-[480px] rounded-2xl overflow-hidden cursor-pointer shadow-sm hover:shadow-xl transition-shadow duration-300"
              >
                {/* Background Image */}
                <div className="absolute inset-0">
                  <img 
                ...
                <div className="absolute top-4 left-4 z-10">
                  <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/30 backdrop-blur-sm">
                    ...
                    <span className="text-cream text-sm font-semibold">{feature.stats}</span>
                  </div>
                </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-7 z-10">
                  <h3 className="font-display text-2xl md:text-3xl text-cream mb-2 font-bold">{feature.title}</h3>
                  <p className="text-cream/85 text-base md:text-lg leading-relaxed">
                    {feature.shortText}
                  </p>
                </div>
                ...
                <motion.div
                  ...
                  animate={{ y: isHovered ? "0%" : "100%" }}
                  transition={{ duration: 0.4, ease: "easeInOut" }}
                  className="absolute inset-x-0 bottom-0 z-20 bg-gradient-to-t from-forest-deep via-forest-deep to-forest-deep/95 rounded-t-2xl overflow-hidden"
                  style={{ height: "65%" }}
                >
                  <div className="h-full p-5 md:p-6 flex flex-col">
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      <Icon className="w-6 h-6 text-gold" />
                      <h3 className="font-display text-2xl md:text-3xl text-cream font-bold">{feature.title}</h3>
                    </div>

                    {/* Full Description */}
                    <p className="text-cream/85 text-base md:text-lg leading-relaxed mb-4 flex-1">
                      {feature.text}
                    </p>

                    {/* Certifications */}
                    <div className="mb-3">
                      <p className="text-gold text-sm uppercase tracking-wider mb-2 font-semibold">Certifications</p>
                      <div className="flex flex-wrap gap-2">
                        {feature.certifications.map((cert, idx) => (
                          <span key={idx} className="px-3 py-1 rounded-full bg-cream/10 text-cream/80 text-sm">
                            {cert}
                          </span>
                        ))}
                      </div>
                    ...
                    <a
                      href="#contact"
                      className="inline-flex items-center justify-center gap-3 px-6 py-3 bg-gold text-forest-deep font-semibold text-base rounded-xl hover:bg-amber-500 transition-all duration-300"
                    >
                      Enquire Now
                ...
                {/* Progress Indicator */}
                <div className="absolute bottom-0 left-0 right-0 h-1.5 bg-gold/30 z-10">
                  <motion.div
                    initial={{ width: "0%" }}
                    animate={{ width: isHovered ? "100%" : "0%" }}
                    transition={{ duration: 0.4 }}
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <a
              href="#contact"
              className="group inline-flex items-center gap-3 px-8 py-4 bg-forest-deep text-white font-semibold rounded-xl hover:bg-forest transition-all duration-300 shadow-md hover:shadow-lg text-base md:text-lg"
            >
              Start Global Sourcing
            ...
            <a
              href="#products"
              className="group inline-flex items-center gap-3 px-8 py-4 border-2 border-forest-deep/20 text-forest-deep font-semibold rounded-xl hover:bg-forest-deep/5 transition-all duration-300 text-base md:text-lg"
            >
              View Collection
          ...
          <div className="flex items-center justify-center gap-6 mt-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm md:text-base text-gray-500">Trusted by 500+ buyers</span>
            </div>
            <div className="w-px h-4 bg-gray-300" />
            <div className="flex items-center gap-2">
              <Users className="w-4 h-4 text-gold" />
              <span className="text-sm md:text-base text-gray-500">50+ countries served</span>
            </div>
          </div>
        </motion.div>
      </div>
