...
const benefits = [
  ...
  },
  {
    ...
    shortDesc: "Free delivery on orders ₹50,000+",
    description: "Fast and reliable delivery across all major cities. Insurance cover and real-time tracking for every shipment.",
    features: ["Pan India", "Insurance Cover", "Real-time Tracking"],
    image: benefitImages["Free Pan India Shipping"],
    stat: "Free Delivery"
  },
  {
    icon: Package,
